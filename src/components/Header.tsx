...
import { Menu, X, Moon, Sun, Download, Zap } from 'lucide-react';
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          {/* Logo */}
          <Link to="/" className="flex items-center space-x-3 group" aria-label="Arvind Ji Cracks home">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">Discover curated software repacks</p>
              <span className="sr-only">Browse curated repacks, compare ratings and download mirrors</span>
            </div>
          </Link>
        ...
        >
          <nav className="py-4 space-y-2">
            ...
            <Link
              to="/software"
              onClick={() => setIsMenuOpen(false)}
              className="flex items-center space-x-2 mx-4 mt-4 btn-primary justify-center"
            >
              <Download className="w-4 h-4" />
              <span>Browse Software</span>
            </Link>
